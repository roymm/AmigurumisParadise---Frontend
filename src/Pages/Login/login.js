                ...
                <div className="p-8 flex-1">
                    <div className="w-80 bg-white rounded-3xl mx-auto overflow-hidden shadow-xl">
                        ...
                        <div className="max-w-md w-full mx-auto">
                            ...
                            <div className="text-center font-medium text-xl">Ingrese su informacion</div>
                        </div>
                            ...
                            <div className="mt-8">
                                <form action="" className="space-y-4">
                                    ...
                                    <div className="flex flex-col items-end">
                                        <a href="" className="font-medium text-small text-blue-500 block">¿Olvido su
                                            contraseña?</a>
                                    </div>
                                    <div>
                                        <button
                                            className="w-full py-2 px-4 bg-blue-600 hover:blue-700 rounded-md text-white text-sm">Ingresar
                                        </button>
                                    </div>
                                </form>
                            </div>
